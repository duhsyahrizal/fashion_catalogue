...
const girlFashion = document.querySelector(".product-girl");
const manFashion = document.querySelector(".product-man");
const kidFashion = document.querySelector(".product-kid");
const hijabFashion = document.querySelector(".product-hijab");
const accFashion = document.querySelector(".product-acc");
