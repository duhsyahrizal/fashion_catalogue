...
const favContainer = document.querySelector('.fav-area');
const featuredGf = document.querySelector(".product-dom-gfe");
const featuredMf = document.querySelector(".product-dom-mfe");
const featuredKf = document.querySelector(".product-dom-kfe");
const featuredHijab = document.querySelector(".product-dom-hfe");
const featuredAcc = document.querySelector(".product-dom-accfe");
...
class UIAll {
      ...
      <div class="col mb-4">
        <div class="card">
          ...
          <div class="img-container w-100">
            <a href="products/detail?product=${product.title}&category=${product.category.name}" data-id="${product.id}" id="product-id">
          ...
          <div class="card-body">
            <div class="product-name">
              <a href="products/detail?product=${product.title}&category=${product.category.name}" data-id="${product.id}" id="product-id">${product.title}</a>
            </div>
            <div class="product-price pb-1 t-bold">
              <a href="products/detail?product=${product.title}&category=${product.category.name}" data-id="${product.id}" id="product-id">IDR. ${moneywithDot}</a>
            </div>
  ...
  // get Buttons dom Mobile to add to favorites
  getFavButtonsMobile(){
    const buttonsMobile = [...document.querySelectorAll('.btn-product')];
